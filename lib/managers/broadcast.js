...
function UdpBroadcastManager(options) {
  ...
  // TODO(schoon) - Implement timeouts.
...
function removeLocalService(service) {
  ...
  self._send('unavailable', service);
...
function _initSocket() {
  ...
  self.socket.on('message', function (message) {
    ...
    self.emit(event, service.name, service);
  });
